...

{
    ...
    { {AT_STING, AF_REACH_STING, 40}, AT_NO_ATK,
      AT_NO_ATK, AT_NO_ATK },
    14, 990,
    20, 5, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...
{
    MONS_SPITTING_SPIDER, 's', YELLOW, "spitting spider",
    M_NO_SKELETON,
    MR_VUL_POISON,
    14, MONS_SPIDER, MONS_SPITTING_SPIDER, MH_NATURAL, 20,
    { {AT_BITE, AF_POISON_PARALYSE, 27}, AT_NO_ATK, AT_NO_ATK, 
        AT_NO_ATK },
    7, 510,
    6, 10, MST_SPITTING_SPIDER, true, S_HISS,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_ARACHNID,
    {TILEP_MONS_SPITTING_SPIDER}, TILE_ERROR
},
